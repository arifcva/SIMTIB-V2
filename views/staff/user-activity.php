    ...
    <div class="flex h-screen">
        ...
        <div class="bg-indigo-900 text-white w-64 p-4 h-full overflow-y-auto">
            ...
            <ul id="sidebarMenu">
                ...
                <li><a href="user-activity.php" class="text-lg block py-2 bg-indigo-600 text-white px-4 rounded-lg transition">
        ...
        <div class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="flex justify-between items-center bg-white p-4 shadow-sm rounded-lg mb-6">
                <div class="text-lg font-bold text-gray-800">Aktivitas Pengguna - Staff</div>
                <div>
            ...
            <!-- Aktivitas Pengguna Section -->
            <div class="bg-white p-6 shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Log Aktivitas Pengguna</h3>
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        <tr class="border-b">
                            ...
                            <td class="py-2 px-4">Admin login ke sistem</td>
                            <td class="py-2 px-4">2025-08-09 08:30:00</td>
                            <td class="py-2 px-4">
                                <span class="activity-status activity-login">Login</span>
                            </td>
                        </tr>
                        <tr class="border-b">
                            <td class="py-2 px-4">2</td>
                            <td class="py-2 px-4">Staff A menyelesaikan tugas 25</td>
                            <td class="py-2 px-4">2025-08-09 10:00:00</td>
                            <td class="py-2 px-4">
                                <span class="activity-status activity-task">Selesai Tugas</span>
                            </td>
                        </tr>
                        <tr class="border-b">
                            <td class="py-2 px-4">3</td>
                            <td class="py-2 px-4">Staff B menambahkan komentar pada tugas 10</td>
                            <td class="py-2 px-4">2025-08-09 12:30:00</td>
                            <td class="py-2 px-4">
                                <span class="activity-status activity-comment">Menambahkan Komentar</span>
                            </td>
                        </tr>
                        <tr class="border-b">
                            <td class="py-2 px-4">4</td>
                            <td class="py-2 px-4">Admin logout dari sistem</td>
                            <td class="py-2 px-4">2025-08-09 14:00:00</td>
                            <td class="py-2 px-4">
                                <span class="activity-status activity-login">Logout</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
